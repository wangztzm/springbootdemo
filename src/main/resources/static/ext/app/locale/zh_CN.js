Ext.define('Ming.locale.zh_CN', {
    override: 'Ming.locale.Locale',
    ...
    statics: {
        ...
        Error404HTML: '<div>页面不存在</div><div>尝试返回<a href="#home">首页</a></div>',
        Error500HTML: '<div>服务器内部错误</div><div>尝试返回<a href="#home">首页</a></div>',
