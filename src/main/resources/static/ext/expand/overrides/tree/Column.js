Ext.define('expand.overrides.tree.Column', {
    ...
    disabledCls: [Ext.baseCSSPrefix + 'form-item-default', Ext.baseCSSPrefix + 'item-disabled'].join(' '),
    ...
    cellTpl: [
        ...
        ' class="{childCls} {checkboxCls}<tpl if="checked"> {checkboxCls}-checked</tpl> <tpl if="disabled">{disabledCls}</tpl>"></div>',
        '</tpl>',
