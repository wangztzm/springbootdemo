Ext.define('Ming.expand.ux.BtnGridQuery', {
    ...
    createQueryWin: function () {
        ...
        if (me.queryWin == null) {
            ...
            var connector = Ext.create('Ext.form.field.ComboBox', {
                emptyText: '条件方式',
                name: 'connector',
                viewname: 'v_connector',
                allowBlank: false
            });
            var fieldcode = Ext.create('Ext.form.field.ComboBox', {
                emptyText: '字段名称', name: 'property', datas: fields, width: 150, allowBlank: false,
                listeners: {
            ...
            var operate = Ext.create('Ext.form.field.ComboBox', {
                emptyText: '比较符', name: 'operator', viewname: 'v_operate', allowBlank: false,
                listeners: {
                    select: function (combo, record, eOpts) {
                        textValue.setValue('');
            ...
            var textValue = Ext.create('Ext.form.field.Text', {
                name: 'value',
                width: 150,
                type: 'string',
                emptyText: '比较符',
            ...
            var numberValue = Ext.create('Ext.form.field.Number', {
                name: 'value',
                width: 150,
                type: 'number',
                hidden: true,
            ...
            var boxValue = Ext.create('Ext.form.field.ComboBox', {
                name: 'value',
                width: 150,
                type: 'combobox',
                hidden: true,
            ...
            var dateValue = Ext.create('Ext.form.field.Date', {
                name: 'value',
                width: 150,
                type: 'datetime',
                format: 'Y-m-d',
            ...
            var treePanel = Ext.create('Ext.tree.Panel', {
                store: store, rootVisible: false, tbar: [formPanel], hideHeaders: true,
                columns: [
                    {xtype: 'treecolumn', flex: 1, sortable: false, dataIndex: 'text'},
                    {
                        ...
                        items: [{
                            ...
                            tooltip: '删除记录',
                            handler: function (tree, rowIndex, colIndex, item, e, record, row) {
            ...
            var buttons = [{
                text: '清除条件', scope: this, handler: function () {
