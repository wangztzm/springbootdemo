 ...
 *
 * {xtype:'datetimefield',fieldLabel: '出生年月1',name: 'birthdate1'},
 * {xtype:'datetimefield',fieldLabel: '风格1',name: 'birthdate2',cfg:{theme:'android-ics light',mode:'scroller',maxDate: new Date()}},
 * {xtype:'datetimefield',fieldLabel: '风格2',name: 'birthdate3',cfg:{mode:'scroller'}},
 * {xtype:'datetimefield',fieldLabel: '日期',name: 'birthdate4',preset:'date'},
 * {xtype:'datetimefield',fieldLabel: '年月',name: 'birthdate5',preset:'date',cfg:{dateFormat:'yy-mm',dateOrder:'yymm'}},
 * {xtype:'datetimefield',fieldLabel: '时间',name: 'birthdate6',preset:'time'},
 * {xtype:'datetimefield',fieldLabel: '随意组合',name: 'birthdate7',cfg:{dateFormat:'dd-yy-mm',timeFormat:'ss/HH:ii',dateOrder:'mmddyy',timeWheels:'ssiiHH'}},
 */
Ext.define('Ming.expand.ux.DateTimeField', {
